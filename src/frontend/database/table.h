...
public:
    ...
    void delete_record(int total_row, int row_id, int size);              // delete record with x row_id
    void update_record(int start, char* buffer, int row_id, int size, int count);
